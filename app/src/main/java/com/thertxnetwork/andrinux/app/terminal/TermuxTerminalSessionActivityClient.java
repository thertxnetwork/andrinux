...
import com.thertxnetwork.andrinux.shared.termux.terminal.io.BellHandler;
import com.thertxnetwork.andrinux.shared.logger.Logger;
import com.thertxnetwork.andrinux.terminal.TerminalColors;
...
import com.thertxnetwork.andrinux.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.thertxnetwork.andrinux.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.thertxnetwork.andrinux/com.thertxnetwork.andrinux.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
