...
import com.thertxnetwork.andrinux.app.event.SystemEventReceiver;
import com.thertxnetwork.andrinux.app.terminal.TermuxTerminalSessionActivityClient;
import com.thertxnetwork.andrinux.app.terminal.TermuxTerminalSessionServiceClient;
import com.thertxnetwork.andrinux.shared.termux.plugins.TermuxPluginUtils;
import com.thertxnetwork.andrinux.shared.data.IntentUtils;
import com.thertxnetwork.andrinux.shared.net.uri.UriUtils;
import com.thertxnetwork.andrinux.shared.errors.Errno;
import com.thertxnetwork.andrinux.shared.shell.ShellUtils;
import com.thertxnetwork.andrinux.shared.shell.command.runner.app.AppShell;
import com.thertxnetwork.andrinux.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.thertxnetwork.andrinux.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.thertxnetwork.andrinux.shared.termux.shell.TermuxShellUtils;
...
import com.thertxnetwork.andrinux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.thertxnetwork.andrinux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.thertxnetwork.andrinux.shared.termux.shell.TermuxShellManager;
...
import com.thertxnetwork.andrinux.shared.notification.NotificationUtils;
...
import com.thertxnetwork.andrinux.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.thertxnetwork.andrinux.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.thertxnetwork.andrinux.shared.R.string.error_execution_cancelled))) {
