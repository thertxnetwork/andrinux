...
import com.thertxnetwork.andrinux.shared.reflection.ReflectionUtils;
...
import com.thertxnetwork.andrinux.shared.android.PackageUtils;
import com.thertxnetwork.andrinux.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.thertxnetwork.andrinux`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.thertxnetwork.andrinux/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.thertxnetwork.andrinux" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.thertxnetwork.andrinux.shared.R.raw.apt_info_script);
        try {
