package com.thertxnetwork.andrinux.shared.activities;
...
import com.thertxnetwork.andrinux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.thertxnetwork.andrinux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.thertxnetwork.andrinux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
