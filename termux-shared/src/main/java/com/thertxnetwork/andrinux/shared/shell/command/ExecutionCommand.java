package com.thertxnetwork.andrinux.shared.shell.command;
...
public class ExecutionCommand {
    ...
    */
     ...
     * commands. By default, @link com.thertxnetwork.andrinux.shared.shell.StreamGobbler} only logs stdout and
