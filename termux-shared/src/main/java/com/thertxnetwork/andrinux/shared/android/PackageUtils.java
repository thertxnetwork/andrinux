package com.thertxnetwork.andrinux.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.thertxnetwork.andrinux.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.thertxnetwork.andrinux/10xxx}
             */
